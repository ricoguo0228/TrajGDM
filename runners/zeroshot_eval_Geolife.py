...
def zeroshot_evaluation(args):
    ...
    traj_diffusion = torch.load('./trained_models/trajGDM_' + args.dataset + '.pkl',map_location=device)  #1886.1173384562853  2069.451043839629
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='Geolife', type=str) #TDrive
